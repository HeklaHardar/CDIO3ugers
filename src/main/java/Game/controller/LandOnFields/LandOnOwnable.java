...
public class LandOnOwnable {
    ...
    public void Ownable(MatadorGui matadorGUI, FieldController fieldProperties, Player currentPlayer, int playerID, Player[] player, int dices, String[] playerNames, Cards cards) {
